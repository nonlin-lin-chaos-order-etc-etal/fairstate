...
# Создание анимированного варианта невозможно с помощью Graphviz напрямую,
# но мы создадим статичную карту как основу для будущей анимации и сохраним SVG и PNG
